...
module.exports.execute = async (client, interaction, data) => {
    if (!await client.tools.userHasItem("fishing_rod")) return await interaction.reply({ content: "You need a fishing rod to use this command. Use `/shop buy fishing_rod` to buy a fishing rod.", ephemeral: true });
