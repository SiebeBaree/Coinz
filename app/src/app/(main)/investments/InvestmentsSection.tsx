...
export default function InvestmentsSection({ data }: { data: Investment[] }) {
...
function InvestmentCard({ investment }: { investment: Investment }) {
    return (
        <div className="bg-secondary rounded-md p-4 flex flex-col justify-between gap-6 border border-transparent hover:border-highlight transition-all duration-150 ease-in-out">
