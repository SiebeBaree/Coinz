...
export default function InvestmentsSection({ investments }: { investments: Investment[] }) {
    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            >
                {getInvestments(investments, category, searchTerm).map((dataObj: Investment) => (
...
function InvestmentCard({ investment }: { investment: Investment }) {
    return (
        <div className="bg-secondary rounded-md p-4 flex flex-col justify-between gap-6 border border-transparent hover:border-highlight transition-all duration-150 ease-in-out focus:outline-none focus:border-primary">
