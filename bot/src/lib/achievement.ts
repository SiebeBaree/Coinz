...
const achievements: IAchievement[] = [
    {
        ...
        hasAchieved: (member: IMember, _: IUserStats) => (member.premium ? 1 : 0) >= 1,
        progress: (member: IMember, _: IUserStats) => `${(member.premium ? 1 : 0) >= 1}/1`,
    },
    {
        id: 'coinz_pro',
        name: 'Coinz Pro',
        ...
        hasAchieved: (member: IMember, _: IUserStats) => (member.premium ? 1 : 0) >= 2,
        progress: (member: IMember, _: IUserStats) => `${(member.premium ? 1 : 0) >= 2}/1`,
    },
    {
        id: 'hard_work',
