...
const achievements: IAchievement[] = [
    ...
    },
    {
        ...
        hasAchieved: (_: IMember, userStats: IUserStats) => userStats.dailyActivity.totalCommands >= 1000,
    ...
    },
    {
        ...
        hasAchieved: (_: IMember, userStats: IUserStats) => userStats.dailyActivity.totalCommands >= 10000,
    ...
    },
    {
        ...
        hasAchieved: (member: IMember) => false,
    ...
    },
    {
        ...
        hasAchieved: (_: IMember, userStats: IUserStats) => userStats.games.moneySpent >= 100000,
...
export default class Achievement {
    ...
    public async sendAchievementMessage(interaction: ChatInputCommandInteraction, memberId: string, achievement: IAchievement | null, force = false): Promise<void> {
